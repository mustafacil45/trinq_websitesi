...
export default function UsersSection() {
  return (
    <section className="bg-[color:var(--background)] py-20 sm:py-24 lg:py-28" id="kullanicilar">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            >
              <motion.a
                href="#indir"
                className="inline-flex rounded-full bg-trinq-accent px-6 py-3.5 text-base font-semibold text-white shadow-[0_4px_14px_-2px_rgba(0,0,0,0.18)] transition hover:bg-trinq-accent-hover"
          ...
          >
            <motion.div
              className="relative w-[240px] sm:w-[260px] lg:w-[260px] cursor-default"
              whileHover={{ y: -6 }}
